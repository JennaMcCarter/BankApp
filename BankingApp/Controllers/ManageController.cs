...
namespace BankingApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //Jenna McCarter - see current balance by passing in last transaction
        public ActionResult SavingsAccountBalance()
        {
        ...
        //Jenna McCarter - withdraw amount and pass in last transaction so use can see current balance
        public ActionResult SavingsAccountWithdraw()
        {
            accountSavingsModel latest = getLatestTransaction();
            return View(latest);
        }
        ...
        //Jenna McCarter - subtract withdraw amount from current balance
        [HttpPost]
        public ActionResult SavingsAccountWithdraw(accountSavingsModel svg)
        {
        ...
        //Jenna McCarter - add deposit amount to current balance
        [HttpPost]
